    ...
    <div class="wrapper">
      ...
      >
        ...
        <el-form-item label="密码" prop="pass">
         ...
         <router-link to="/register" style="color: #409eff; margin-left: 66px;">还没有账号？去注册</router-link>
...
<script>
import { reqGetLogin } from "@/api/request/login";
...
export default {
  ...
  methods: {
    ...
    async login(userName, passWord) {
      ...
      let res = await reqGetLogin(userInfo);
      // 关闭遮罩层
      this.fullscreenLoading = false;
